...
// this happens when the "done" functions from below are executed
// this stuff sets the user.id in a cookie
...
passport.use(
    ...
    // refreshToken: para refrescar el accessToken si este caduca. como no usamos el primero, no usamos el segundo
